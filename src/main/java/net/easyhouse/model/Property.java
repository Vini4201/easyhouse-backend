...
public class Property {
	...
	public Date getPropertyPostDate() {
		return propertyPostDate;
	}

	public void setPropertyPostDate(Date propertyPostDate) {
	...
	public Property(Integer sellerId, String propertyName, String propertyType, Double propertyCost,
			...
			PropertyStatus propertyStatus, Date propertyPostDate) {
		super();
		this.sellerId = sellerId;
		this.propertyName = propertyName;
		this.propertyType = propertyType;
