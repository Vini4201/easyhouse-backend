...
public class UserController {
    ...
    public ResponseEntity<User> registerUser(@Valid @RequestBody User user, HttpServletResponse response) {
    	User u = userService.registerUser(user);
//    	response.setHeader("Location", "/login"); // Redirect to /login after successful registration
